...
CREATE TABLE IF NOT EXISTS info (
    ...
    download_default_filters_json LONGTEXT DEFAULT NULL,
    download_naming_tokens_text LONGTEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS segments (
    ...
    template_source VARCHAR(20) NOT NULL DEFAULT 'autogenerated',
...
CREATE TABLE IF NOT EXISTS asset_fields (
    ...
    is_common_download_field TINYINT NOT NULL DEFAULT 0,
    is_download_level1 TINYINT NOT NULL DEFAULT 0,
    is_download_filter TINYINT NOT NULL DEFAULT 0,
    is_download_sort TINYINT NOT NULL DEFAULT 0,
    is_download_zip_file_selectable TINYINT NOT NULL DEFAULT 0,
