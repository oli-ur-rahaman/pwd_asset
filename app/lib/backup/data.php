...
function save_info_row(?string $video_url, ?string $login_message, array $extras = []): void
{
    ...
    $download_naming_tokens_text = array_key_exists('download_naming_tokens_text', $extras)
        ? $extras['download_naming_tokens_text']
        : ($existing['download_naming_tokens_text'] ?? null);
